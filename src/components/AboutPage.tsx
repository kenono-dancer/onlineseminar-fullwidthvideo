          ...
          <div className="bg-card rounded-[2rem] border-none shadow-lg">
            <div className="space-y-6 p-8 md:p-12">
              <div className="space-y-4">
                <h2 className="font-heading text-foreground text-2xl font-bold">Our Mission</h2>
                <p className="text-muted-foreground text-lg leading-relaxed">
                  At Purrfectly Zen, we believe that cats are the ultimate meditation teachers. They embody stillness, presence, and the art of doing absolutely nothing—which is actually everything.
                </p>
              </div>
              <div className="space-y-4">
                <h2 className="font-heading text-foreground text-2xl font-bold">Why Cats?</h2>
                <p className="text-muted-foreground text-lg leading-relaxed">
                  Cats teach us the philosophy of zen through their everyday actions. They don't overthink. They rest when they need to. They appreciate simple moments like a sunny window or a soft lap. Purrfectly Zen helps you embrace these lessons through guided meditation and mindfulness practices.
                </p>
              </div>
              <div className="space-y-4">
                <h2 className="font-heading text-foreground text-2xl font-bold">About Our Name</h2>
                <p className="text-muted-foreground text-lg leading-relaxed">
                  "Purrfect" is a playful wordplay combining two things we love: the soothing sound of a cat's purr and the idea of perfection.{' '}
                  ...
                  It perfectly captures the essence of our mission: using the calming presence of cats to help you find your perfect zen state.
                </p>
              </div>
              <div className="space-y-4">
                <h2 className="font-heading text-foreground text-2xl font-bold">What We Offer</h2>
